  ...
  return (
    <>
      <div className="main-Div">
        {grandData.map((value) => (
          <div className="card mt-3" id = {value.id} style={{ width: 18 + "rem" }}>
      ...
      <h1 className="mt-5">Render 2</h1>
      {
        <div className="main-Div">
          {grandData2.map((value) => (
            ...
            <div className="card-body">
              ...
              <h6 className="card-subtitle mb-2 text-muted">📞 {value.phone}</h6>
              <p className="card-text">
                  Address: {value.address.street}, {value.address.suite}, {value.address.zipcode}, {value.address.city}
                  <br />
                  Geo : lat {value.address.geo.lat}, Lang {value.address.geo.lng}
              </p>
              Website: <a href="javascript:void(0)" class="card-link"> {value.website}</a>
              <h6 className="card-subtitle mb-2 text-muted mt-2">company : {value.company.name}</h6>
              <p className="card-text">
